...
define('client/components/modal-slide', ['exports', 'ember'], function (exports, _ember) {
    ...
    exports['default'] = _ember['default'].Controller.extend({
        actions: {
            previousNews: function previousNews() {
                console.log('NYI previousNews');
            },

            nextNews: function nextNews() {
                console.log('NYI nextNews');
            }
        }
    });
});
...
define('client/routes/application', ['exports', 'ember'], function (exports, _ember) {
    exports['default'] = _ember['default'].Route.extend({
        model: function model(params, transition) {
            var keywords = ['syria', 'whatever'];

            return keywords;
        }
    });
});
define('client/routes/demo', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({});
});
define('client/routes/news', ['exports', 'ember'], function (exports, _ember) {
    exports['default'] = _ember['default'].Route.extend({
        model: function model(params, transition) {
            return _ember['default'].$.getJSON('/api/news').then(function (response) {
                return response;
            });
        }
    });
...
define("client/templates/components/modal-slide", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      meta: {
        ...
        "moduleName": "client/templates/components/modal-slide.hbs"
      },
      isEmpty: false,
      arity: 0,
      cachedFragment: null,
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el2 = dom.createTextNode("modal stuff");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        return el0;
      },
...
define("client/templates/demo", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      meta: {
        "fragmentReason": false,
        ...
        "moduleName": "client/templates/demo.hbs"
      },
      isEmpty: false,
      arity: 0,
      cachedFragment: null,
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el2 = dom.createTextNode("Demo page. No content yet, sorry!");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        return el0;
      },
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.setAttribute(el1, "class", "keyword");
          var el2 = dom.createTextNode("\n            Refugees\n        ");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n");
    ...
    var child1 = (function () {
      var child0 = (function () {
        return {
          ...
          statements: [["content", "keyword", ["loc", [null, [10, 34], [10, 45]]]]],
          locals: [],
          templates: []
        };
      })();
      return {
        ...
        statements: [["block", "link-to", ["demo"], [], 0, null, ["loc", [null, [9, 8], [11, 20]]]]],
        locals: ["keyword"],
        templates: [child0]
      };
    })();
    return {
      ...
      buildFragment: function buildFragment(dom) {
        var el0 = dom.createDocumentFragment();
        var el1 = dom.createElement("div");
        dom.setAttribute(el1, "class", "keyword-container");
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
        var el2 = dom.createComment("");
        dom.appendChild(el1, el2);
